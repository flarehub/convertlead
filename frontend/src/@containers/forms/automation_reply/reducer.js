...
import {
  CHANGE_AUTOMATION_REPLY_ACTION,
  LOAD_AUTOMATION_REPLY_ACTION,
  SAVED_AUTOMATION_REPLY_ACTION
} from './actions';
...
const automationReplyForm = (state = initState, action) => {
  switch (action.type) {
    case LOAD_AUTOMATION_REPLY_ACTION: {
      return {
        ...state,
        form: {
    ...
    case CHANGE_AUTOMATION_REPLY_ACTION: {
      return {
        ...state,
        form: {
          ...state.form,
    ...
    case SAVED_AUTOMATION_REPLY_ACTION: {
      return {
        ...state,
        form: {
          ...state.form,
