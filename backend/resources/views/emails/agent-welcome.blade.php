...
<div class="emailbody">
	...
	<div class="bigcont">
		<p>Hey {{ $agent->name  }}, </br></br> {{ $company->name  }} just added you to their ConvertLead team. Welcome ! </p></br>


		<p><p>Please take a second to download our mobile. Once you do that, you'll be able to login to your account using the following details: </p>

		<h1>User: {{$agent->email}}</h1>
