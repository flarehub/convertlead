...
<div class="emailbody" style="width:100%; height:100%; display:block; margin:0 auto; background:#f1f4f5; padding: 60px 0; ">
	...
	<div class="bigcont" style="max-width: 320px; background:#fff; border: 1px dashed #b3b3b3; padding: 70px 55px 55px 55px; margin: 0 auto; border-radius: 6px; color:#354771;">
		<p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Hey, </br></br> A new lead was manually subscribed for {{$deal->name}}, integration {{$campaign->name}}:</p>


		<p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Name: {{$lead->fullname}}, </br>
			Email:{{$lead->email}},</br>
		...
		<p   style="font-size:12px ; text-align:center ; " class="smallnote">Need help ? <a href="https://support.convertlead.com">Let us know</a></p>
