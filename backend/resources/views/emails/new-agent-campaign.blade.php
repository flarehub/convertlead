...
<div class="emailbody" style="width:100%; height:100%; display:block; margin:0 auto; background:#f1f4f5; padding: 60px 0; ">
	...
	<div class="bigcont" style="max-width: 380px; background:#fff; border: 1px dashed #b3b3b3; padding: 55px; margin: 0 auto; border-radius: 6px; color:#354771;">
        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Hey, </br></br> You've just been assigned to a new ConvertLead campaign : </p>
		<h1 style=" font-size: 17px; font-family: Arial, sans-serif; font-weight: 600; color:#354771; " >{{$campaign->name}}  <span style="font-style:italic;">{{$campaign->created_at}}</span></h1>
		<h2 style=" font-size: 17px; font-family: Arial, sans-serif; font-weight: 600; ">Company: {{$company->name}}</h2>
		<p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Just click below to download our mobile app and start calling your leads: </p>
