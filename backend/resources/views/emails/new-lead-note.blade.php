...
<div class="emailbody">
	...
	<div class="bigcont" style="max-width: 380px; background:#fff; border: 1px dashed #b3b3b3; padding: 55px; margin: 0 auto; border-radius: 6px; color:#354771;">>
		<p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Hey, </br></br> A new lead note was added to {{$lead->fullanem}} : </p></br>


		<p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; "> {{$leadNote->message}} </p>
