...
<div class="emailbody" style="width:100%; height:100%; display:block; margin:0 auto; background:#f1f4f5; padding: 60px 0; ">
    ...
    <div class="bigcont" style="max-width: 320px; background:#fff; border: 1px dashed #b3b3b3; padding: 70px 55px 55px 55px; margin: 0 auto; border-radius: 6px; color:#354771;">
        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Hey, </br></br> Your password has been changed : </p>

        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; "> Email: {{$user->email}}</p>
        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; "> New password: {{$password}}</p>
        ...
        <p  style="font-size:12px ; text-align:center ; " class="smallnote">Didn’t change your password?<a href="https://support.convertlead.com">Let us know</a></p>
