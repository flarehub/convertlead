...
<div class="emailbody" style="width:100%; height:100%; display:block; margin:0 auto; background:#f1f4f5; padding: 60px 0; ">
    ...
    <div class="bigcont" style="max-width: 320px; background:#fff; border: 1px dashed #b3b3b3; padding: 70px 55px 55px 55px; margin: 0 auto; border-radius: 6px; color:#354771;">
        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Hey, </br></br> A new integration was just registered for {{$company->name}} : </p>
        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">{{$campaign->name}}</p>
        <p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Registered at {{$campaign->created_at}} </p>
        ...
        <p class="smallnote" style="font-size:12px ; text-align:center ; ">Need help ? <a href="https://support.convertlead.com" style="color:#005ff8; text-decoration:none ;
